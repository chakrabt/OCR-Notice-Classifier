...
def example_3_confidence_filtering():
    ...
    if result['confidence_score'] < confidence_threshold:
        ...
        print(f"    Consider manual review for this notice.")
...
def example_4_from_file():
    ...
    # Split by separator (assuming notices are separated by "---")
    notices = [n.strip() for n in content.split('---') if n.strip()]
...
def example_5_custom_integration():
    ...
    if result['confidence_score'] >= 0.85:
        ...
        print(f"\n[4] Action:  Flagged for manual review (low confidence)")
...
def main():
    ...
    try:
        ...
        print("   - ocr_90_model.pkl")
        print("   - ocr_90_vectorizer.pkl")
        print("   - ocr_90_encoder.pkl")
        print("   - ocr_90_metadata.pkl\n")
